...
urlpatterns = [
    ...
    path('comment-group-post/', views.comment_on_group_post,
         name='comment-group-post'),
    path('delete-group-post/', views.delete_group_post, name='delete-group-post'),
    path('like-group-post-comment/', views.like_group_post_comment,
         name='like-group-post-comment'),
    path('reply-group-post-comment/', views.reply_group_post_comment,
         name='reply-group-post-comment'),
    path('delete-group-post-comment/', views.delete_group_post_comment,
         name='delete-group-post-comment'),
    path('delete-group-post-reply/', views.delete_group_post_reply,
         name='delete-group-post-reply'),
